...
class SimFrame extends JFrame {
    ...
    double tokenGenProb = 1.00; // probability that a stimulus generates a token at each step

    double walkProb = 1.00;     // probability that token continues walking

    int tokenMaxHops = 1200;

    int delayMs = 80;// delay between steps in milliseconds
